...
import stylesCss from 'themes/resources/styles.css?inline';
...
import gridColorCss from 'themes/resources/components/grid-color.css?inline';
import inputFieldColorCss from 'themes/resources/components/input-field-color.css?inline';
import tabColorCss from 'themes/resources/components/tab-color.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_resources_componentCss']) {
    registerStyles(
      'grid-color',
      unsafeCSS(gridColorCss.toString())
    );
    registerStyles(
      'input-field-color',
      unsafeCSS(inputFieldColorCss.toString())
    );
    registerStyles(
      'tab-color',
      unsafeCSS(tabColorCss.toString())
    );
    
    document['_vaadintheme_resources_componentCss'] = true;
  }
